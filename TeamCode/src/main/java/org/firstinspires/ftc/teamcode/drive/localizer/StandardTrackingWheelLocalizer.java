...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 6; // in; distance between the left and right wheels, assuming wheels centered on tracking center X axis
    ...
    public StandardTrackingWheelLocalizer(HardwareMap hardwareMap) {
        ...
        strafeEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "frontEncoder"));
